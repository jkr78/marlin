...
class _NmeaModule:
    ...
    class TargetStatus:
        LOST: "_NmeaModule.TargetStatus"
        QUERY: "_NmeaModule.TargetStatus"
        TRACKING: "_NmeaModule.TargetStatus"
    ...
    class AngleReference:
        ...
        RELATIVE: "_NmeaModule.AngleReference"
    ...
    class DistanceUnits:
        ...
        KILOMETERS: "_NmeaModule.DistanceUnits"
        STATUTE: "_NmeaModule.DistanceUnits"
    ...
    class AcquisitionType:
        ...
        MANUAL: "_NmeaModule.AcquisitionType"
        REPORTED: "_NmeaModule.AcquisitionType"
    ...
    class Ttm:
        ...
        @property
        def bearing_reference(self) -> "_NmeaModule.AngleReference | None": ...
        @property
        def speed(self) -> float | None: ...
        @property
        def course_deg(self) -> float | None: ...
        @property
        def course_reference(self) -> "_NmeaModule.AngleReference | None": ...
        @property
        def cpa(self) -> float | None: ...
        @property
        def tcpa(self) -> float | None: ...
        @property
        def units(self) -> "_NmeaModule.DistanceUnits | None": ...
        @property
        def name(self) -> str | None: ...
        @property
        def status(self) -> "_NmeaModule.TargetStatus | None": ...
        @property
        def reference_target(self) -> bool: ...
        @property
        def utc_time(self) -> "_NmeaModule.UtcTime | None": ...
        @property
        def acquisition(self) -> "_NmeaModule.AcquisitionType | None": ...
    ...
    class _NmeaIterator:
        ...
        def __next__(
            self,
        ) -> "_NmeaModule.Gga | _NmeaModule.Gll | _NmeaModule.Hdt | _NmeaModule.Rmc | _NmeaModule.Vtg | _NmeaModule.Hdg | _NmeaModule.Ttm | _NmeaModule.Tll | _NmeaModule.Psxn | _NmeaModule.Prdid | _NmeaModule.Unknown": ...
    ...
    class Nmea0183Parser:
        ...
        def next_message(
            self,
        ) -> "_NmeaModule.Gga | _NmeaModule.Gll | _NmeaModule.Hdt | _NmeaModule.Rmc | _NmeaModule.Vtg | _NmeaModule.Hdg | _NmeaModule.Ttm | _NmeaModule.Tll | _NmeaModule.Psxn | _NmeaModule.Prdid | _NmeaModule.Unknown | None": ...
        def __iter__(self) -> "_NmeaModule._NmeaIterator": ...
    ...
    @staticmethod
    def decode_hdg(raw: "_EnvelopeModule.RawSentence") -> "_NmeaModule.Hdg": ...
    @staticmethod
    def decode_ttm(raw: "_EnvelopeModule.RawSentence") -> "_NmeaModule.Ttm": ...
    @staticmethod
    def decode_tll(raw: "_EnvelopeModule.RawSentence") -> "_NmeaModule.Tll": ...
    @staticmethod
